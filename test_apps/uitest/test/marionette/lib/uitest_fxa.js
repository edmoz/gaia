...
UITestFxA.URL = 'app://test-fxa-client.gaiamobile.org';
/*
...
/*    selectFxaTest: function() {
    ...
    selectFxaClientTest: function() {
        this.client.helper.wait(FxA.maxTimeInMS);
        assert.ok(this.onClick(FxA.Selectors.tabOpenFlow) !== -1);
        this.client.switchToFrame();
        this.client.switchToFrame(FxA.Selectors.fxaFrame);
    },
